...
urlpatterns = [
    ...
    path("category/<slug:category__slug>/brand/<slug:brand__slug>/",
         views.ProductCategoryBrandFilteredAPIView.as_view(),
    ...
    path("brand/<slug:brand__slug>/category/<slug:category__slug>/",
         views.ProductBrandCategoryFilteredAPIView.as_view(),
         name="product-brand"),
    path("products/", views.ProductListAPIView.as_view(),
         name="product-list"),
    path("products/<uuid:pk>/",
         views.ProductRetrieveAPIView.as_view(), name="product"),
